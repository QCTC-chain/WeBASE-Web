export default {
    login: {
        ...
        VerificaFailed:"Verification code",
        ForgetPasswordMsg:'If you forget your password, please search',
        VerificaFailedMsg:'If the verification code fails to load, please check whether the network port of the webase service is open. For details, search the',
        FollowPrompt:', in the webase online document and refer to the tips for operation'
    },
    inputText: {
    ...
    text: {
        ...
        appStep11: 'Get registration information through service registration, and register service with webase through API',
        appStep12: 'Connect with webase through the basic capability API provided by webase',
        appStep21: 'Add app',
    ...
    account: {
        ...
        updataAccount: "Modify Account Password",
        email: "Email",
