    ...
    <div class="module-wrapper">
      <div class="desc-wrapper">
        ...
        <div style="margin-top: 36px">
          <p
            class="access-process cursor-pointer"
          ...
          >
            ...
            <span>
              <i
                :class="
                  !processVisible ? 'el-icon-arrow-down' : 'el-icon-arrow-up'
                "
              ></i>
            </span>
          </p>
        ...
        <div style="margin-top: 0px">
          ...
          <div style="margin-top: 24px">
            <el-button
              ...
              @click="creatApp()"
              size="small"
              v-hasPermi="['bcos:appManagement:newApp']"
              >{{ $t("text.creatApp") }}</el-button
            >
          </div>
          <div style="margin-top: 24px">
            <el-row :gutter="20">
                    ...
                    <div class="right-warehouse">
                      <div class="right-warehouse-item store-name">
                        ...
                        <el-button
                          ...
                          v-hasPermi="['bcos:appManagement:updateApp']"
                        ...
                        <el-button
                          ...
                          v-hasPermi="['bcos:appManagement:deleteApp']"
                          >{{ $t("text.delete") }}</el-button
                        >
                      </div>
                      <div
                        class="right-warehouse-item store-desc one-ellipsis"
                        style="margin-top: 6px; color: #2e384d"
                        :title="item.appDesc"
                      >
                        {{ item.appDesc }}
                      </div>
                      <div
                        class="right-warehouse-item store-desc two-ellipsis"
                        style="color: #666666"
                        :title="item.appDetail"
                      >
                        {{ item.appDetail }}
                      </div>
                      <div
                        class="right-warehouse-item"
                      ...
                      >
                        <el-button
                          ...
                          class="btn-item"
                          >{{ $t("text.registerInfo") }}</el-button
                        >
                        <el-button
                          type="primary"
                          size="small"
                          @click="introduction(item)"
                          style="margin-right: 5px"
                          class="right-btn-item"
                          >{{ $t("text.appIntroduction1") }}</el-button
                        >
                        <el-button
                          :disabled="
                            item.appStatus == '2' || item.appStatus == '0'
                          "
                          type="primary"
                          size="small"
                          @click="linkService(item)"
                          class="right-btn-item"
                          >{{ linkText(item) }}</el-button
                        >
...
export default {
  ...
  methods: {
    ...
    sureDeleteApp(val) {
      fetchDeleteApp(val.id).then((res) => {
        if (res.data.code === 0) {
          this.$message({
            type: "success",
