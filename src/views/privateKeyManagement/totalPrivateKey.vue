  ...
  <div class="module-wrapper">
    ...
    <div class="search-table">
      <el-table :data="userList" tooltip-effect="dark" v-loading="loading">
        <el-table-column
          prop="address"
          :label="$t('privateKey.userAddress')"
        ...
        >
          <template slot-scope="scope">
            <i
              ...
              @click="copyPubilcKey(scope.row.address)"
              :title="$t('privateKey.userAddress')"
            ></i>
        ...
        >
          <template slot-scope="scope">
            <i
              class="wbs-icon-copy font-12 copy-public-key"
              v-if="scope.row.signUserId"
              @click="copyPubilcKey(scope.row.signUserId)"
              :title="$t('privateKey.signUserId')"
            ></i>
