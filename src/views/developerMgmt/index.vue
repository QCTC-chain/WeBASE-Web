    ...
    <div>
      <div>
        <el-button
          type="primary"
          :disabled="disabled"
          @click="addDeveloper('add')"
          v-hasPermi="['bcos:sys:grantOperator']"
          >{{ this.$t("devOpsMgmt.addDeveloper") }}</el-button
        >
      </div>
      <div>
        <el-table :data="devOpslist" tooltip-effect="dark" v-loading="loading">
          <el-table-column
            v-for="head in devOpsHead"
            :label="head.name"
            :key="head.enName"
          ...
          >
            <template slot-scope="scope">
              <template v-if="head.enName != 'operate'">
                <span v-if="head.enName == 'user'">{{
                  userName(scope.row["address"])
                }}</span>
              ...
              <template v-else>
                <el-button
                  ...
                  @click="deleteDeveloper(scope.row, 'delete')"
                  v-hasPermi="['bcos:sys:revokeOperator']"
                  >{{ $t("devOpsMgmt.deleteDeveloper") }}</el-button
                >
              </template>
            </template>
          </el-table-column>
